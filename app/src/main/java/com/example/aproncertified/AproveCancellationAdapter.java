...
public class AproveCancellationAdapter extends RecyclerView.Adapter<AproveCancellationAdapter.AdminViewHolder> {

    Activity context;
    List<FormDetails> formDetails;

    public AproveCancellationAdapter(Activity context, List<FormDetails> formDetails){
    ...
    public AdminViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.approve_cancel_item, parent, false);
